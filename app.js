    ...
    if( cartItems && productContainer ) {
        ...
        Object.values(cartItems).map( (item, index) => {
            ...
            <div class="quantity sm-hide">
                <ion-icon class="decrease " name="remove-circle-outline" style="margin-top: 1%;"></ion-icon>
                    <span">${item.inCart}</span>
                <ion-icon class="increase" name="add-circle-outline" style="margin-top: 10%;"></ion-icon>   
            </div>
            <div class="total" style="margin-top: 3%;">₱${item.inCart * item.price}.00</div>`;
        });
